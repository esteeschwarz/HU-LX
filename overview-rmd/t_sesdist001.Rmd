...
the applied lmer (linear mixed effects regression model) [^2] formula is:  
`count ~ feature + (1 | L1)`  
...
[^2]:	Bates u. a., „Fitting Linear Mixed-Effects Models Using lme4“. 2015. [doi: 10.18637/jss.v067.i01][25-2]

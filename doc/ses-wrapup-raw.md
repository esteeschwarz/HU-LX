...
## info:
please find [here](https://box.fu-berlin.de/s/Hr7Fad5bTjSmtKT) a .docx / pdf version of the pages.  
**mdbook instance:** you can also use the \<print\> button on the top right side to generate an uptodate printed version.  
to make sure you are viewing the most recent version of the wrap up, reload the pages by visiting: [https://pinghook.dh-index.org?page=pfaff-corpusclass-overview](https://pinghook.dh-index.org?page=pfaff-corpusclass-overview)  

for trouble with technical terms/expressions used please consult the glossary at the end.

# EXMARALDA workflow
#### general
- info/download: [EXMARALDA Partitur Editor](https://exmaralda.org/de/partitur-editor-de/)
...
note: this method is demanding fewer technical skills, but takes longer to transcribe = type the text. if you decide to do use a more technical demanding method, which allows for easy and fast transkription, skip to [section 2.2](e1_exmaralda-022.md).  
...
- open the template \<LLDM\_exmaralda\_basictemplate.exb\> which you download from the HU box or [here](https://github.com/esteeschwarz/HU-LX/blob/main/trans/LLDM_exmaralda_basictemplate.exb). 
...
### preliminary
- open the original .pdf you want to transcribe and a simple text editor, rather not word, use [this one (VS Code)](https://code.visualstudio.com) for example. 
- best is to have a parallel view of the .pdf and the editor in horizontal split
- download the template \<LLDM\_exmaralda\_basictemplate.exb\> from the HU box or [here](https://github.com/esteeschwarz/HU-LX/blob/main/trans/LLDM_exmaralda_basictemplate.exb)   
...
- transcribe *every* written form, including stroke through words or phrases, i.e. every information that could be later on analysed
	- you can mark up information like this or use your own (consistent!) system, important is, that you later (see [sec. 2.4](be1_exmaralda-041.md))be able to transfer your marked up information into an annotation in the transcript, e.g. like here where "an" was stroke through in the original text:
...
---- 
### the 2 versions view:
![partitur editor view of .exb file](https://ada-sub.dh-index.org/school/api/png/ses-overview/exm_05.png)

![texteditor view of CHAT file](https://ada-sub.dh-index.org/school/api/png/ses-overview/exm_2_6.png)
...
![the white field shows the selected (markierte) range in the audio](https://ada-sub.dh-index.org/school/api/png/ses-overview/Bildschirmfoto%202022-07-13%20um%2020.57.50.png)
...
![login1](https://ada-sub.dh-index.org/school/api/png/ses-overview/mdb-01-001.png)

![login2](https://ada-sub.dh-index.org/school/api/png/ses-overview/mdb-01-002.png)
...
![filter out #INT speaker](https://ada-sub.dh-index.org/school/api/png/ses-overview/sesdb004-INT.png)

![filter after token schnee](https://ada-sub.dh-index.org/school/api/png/ses-overview/sesdb004-schnee.png)

![analyse turn (manually)](https://ada-sub.dh-index.org/school/api/png/ses-overview/sesdb004-schnee2.png)

![set evaluation column to 1=TRUE if nonstandard occurence (context)](https://ada-sub.dh-index.org/school/api/png/ses-overview/sesdb004-schnee3.png)
...
to dive deeper into the sujet: [https://de.wikipedia.org/wiki/Tastenkombination](https://de.wikipedia.org/wiki/Tastenkombination)
